...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Tue Apr 11 15:19:34 2017
...
expName = 'IAT_and_likerts'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/Ian/git/Analogical learning via the IAT I/Experiment 1/Measures/IAT and likerts.psyexp',
...
rating = visual.RatingScale(win=win, name='rating', marker='triangle', size=1.0, pos=[0.0, -0.4], low=1, high=5, labels=['Not at all', ' Very much'], scale='')
...
if (participant % 4) == 1: 
    taskFile = "blockOrderA_flowers.xlsx"
    likertFile = "likert_flowers.xlsx"
elif (participant % 4) == 2:
    taskFile = "blockOrderB_flowers.xlsx"
    likertFile = "likert_flowers.xlsx"
elif (participant % 4) == 3:
    taskFile = "blockOrderA_insects.xlsx"
    likertFile = "likert_insects.xlsx"
elif (participant % 4) == 0:
    taskFile = "blockOrderB_insects.xlsx"
    likertFile = "likert_insects.xlsx"
else:
...
likertPre = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath='/Users/Ian/git/Analogical learning via the IAT I/Experiment 1/Measures/IAT and likerts.psyexp',
    trialList=data.importConditions(likertFile),
